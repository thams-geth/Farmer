...
//        payUmoneyConfig.setDoneButtonText("Pay " + getResources().getString(R.string.Rupees) + getResources().getString(R.string.txt_product_price));
    ...
    public void calculateHashInServer(final PayUmoneySdkInitializer.PaymentParam mPaymentParams) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (merchantHash.isEmpty() || merchantHash.equals("")) {
                            ...
                            Toast.makeText(MainActivity.this, "hash generated", Toast.LENGTH_SHORT).show();
